...
const SocialShareButtons = ({url, title}) => {
  return (
    <div className='w-full flex justify-between'>
        <a target='_blank' rel='noreferrer' href={`https://www.facebook.com/dialog/share?app_id=1234567890&display=popup&href=${url}`}>
            <FaFacebookSquare className='text-[#30497f] w-12 h-auto'/>
        </a>
