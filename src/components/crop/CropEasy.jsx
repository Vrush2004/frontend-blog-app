        ...
        <div>
          ...
          />
              ...
              <div className="flex justify-between gap-2 flex-wrap">
                  ...
                  <button disabled={isLoading} onClick={handleCropImage} className="px-5 py-2.5 rounded-lg text-white bg-blue-500 text-sm disabled:opacity-70">Crop & Upload</button>
