...
const handleCropImage = async () => {
    try {
        // Make sure getCroppedImg returns a valid image blob
        const croppedImg = await getCroppedImg(photo?.url, croppedAreaPixels);
        
        // Ensure correct capitalization for File and FormData
        ...
        <div className='bg-white h-fit w-full sm:max-w-[350px] p-5 rounded-lg'>
            ...
            <div className='flex justify-between gap-2 flex-wrap'>
                <button 
                    ...
                    className='px-5 py-3 rounded-lg text-red-500 border border-red-500 text-sm disabled:opacity-70'
                >
                    Cancle
                </button>
                <button 
                    ...
                    className='px-5 py-3 rounded-lg text-white bg-green-800 text-sm disabled:opacity-70'
                >
                    Crop & Upload
                </button>
            </div>
