...
const Search = ({className, onSearchKeyword}) => {
  ...
  return (
    <div onSubmit={handleSubmit} className={`flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative ${className}`}>
        ...
        <button 
            type='submit'
            className='w-full bg-green-900 text-white font-semibold rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2'
        >
            Search
        </button>
    </div>
